...
export class TagsComponent extends AppComponentBase {
    @ViewChild('createOrEditTagModal', { static: true }) createOrEditTagModal: CreateOrEditTagModalComponent;
    @ViewChild('viewTagModalComponent', { static: true }) viewTagModal: ViewTagModalComponent;
    ...
    exportToExcel(): void {
        this._tagsServiceProxy.getTagsToExcel(this.filterText, this.nameFilter).subscribe((result) => {
