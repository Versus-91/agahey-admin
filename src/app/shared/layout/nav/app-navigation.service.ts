...
export class AppNavigationService {
    ...
    getMenu(): AppMenu {
        return new AppMenu('MainMenu', 'MainMenu', [
            ...
            new AppMenuItem('Categories', 'Pages.Categories', 'flaticon-more', '/app/main/pages/categories'),
            
            new AppMenuItem('Items', 'Pages.Items', 'flaticon-more', '/app/main/pages/items'),
            
            new AppMenuItem('Collections', 'Pages.Collections', 'flaticon-more', '/app/main/collections/collections'),
            
            new AppMenuItem('SubCollections', 'Pages.SubCollections', 'flaticon-more', '/app/main/subCollections/subCollections'),
            
            new AppMenuItem('Tags', 'Pages.Tags', 'flaticon-more', '/app/main/pages/tags'),
